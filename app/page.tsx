      ...
      <div>
        ...
        <section className="main-section flex flex-col py-11">
          ...
          <div className="grid grid-cols-3 gap-4">
            <Button className="fitur-card text-xl">
              <Image className="mr-1" height={60} alt="pos" radius="none" src="assets/fitur-1.png" removeWrapper/>
              <span>Monografi Hukum</span>
            </Button>
            <Button className="fitur-card text-xl">
              <Image className="mr-1" height={60} alt="pos" radius="none" src="assets/fitur-2.png" removeWrapper/>
              <span>Perkara Hukum</span>
            </Button>
            <Button className="fitur-card text-xl">
              <Image className="mr-1" height={60} alt="pos" radius="none" src="assets/fitur-3.png" removeWrapper/>
              <span>Grafik Statistik</span>
            </Button>
            <Button className="fitur-card text-xl">
              <Image className="mr-1" height={60} alt="pos" radius="none" src="assets/fitur-4.png" removeWrapper/>
              <span>Artikel Hukum</span>
            </Button>
            <Button className="fitur-card text-xl">
              <Image className="mr-1" height={60} alt="pos" radius="none" src="assets/fitur-5.png" removeWrapper/>
              <span>Konstitusional</span>
            </Button>
            <Button className="fitur-card text-xl">
              <Image className="mr-1" height={60} alt="pos" radius="none" src="assets/fitur-6.png" removeWrapper/>
        ...
        <section className="main-section flex flex-col py-11">
          ...
          <div className="grid grid-cols-2 gap-4">
            {
              video && video?.map((value, index) => (
                <Button className="video-card text-xl" key={index}>
                  <div className="video-card-date"><PlayIcon /><span className="ml-2">572</span></div>
                  <Image className="mr-1" width={200} alt="pos" radius="none" src="assets/video_thumbnail.png" removeWrapper/>
                  <div className="text-left text-small">
                    <p className="whitespace-normal font-bold mb-2">UNDANG-UNDANG PERLINDUNGAN DATA PRIBADI - #KOMINFOPEDIA</p>
        ...
        <section className="secondary-section flex flex-col py-11">
          ...
          <div className="grid grid-cols-3 gap-4">
            {
              berita && berita?.map((value, index) => (
                <Button className="flex flex-col berita-card text-small gap-0" key={index}>
                  <Image
                    alt="produk"
                    className="object-cover w-full"
                  ...
                  <div className="berita-card-body">
                    <p style={{ color: "#BBBBBB" }}>Jumat, 13 September 2024</p>
                    <p className="font-bold mt-2">Benchmarking Pengelola JDIH Kementerian Komunikasi dan Informatika dengan Pengelola JDIH Provinsi Bali</p>
                    <span className="font-light mt-2" style={{ color: "#827272" }}>Denpasar, 12/09/2024 – Pengelola Jaringan Dokumentasi dan Informasi Hukum Kementerian Komunikasi dan Informatika (JDIH Kemkominfo) ...</span>
                  </div>
                </Button>
              ))
            }
        ...
        <section className="main-section flex flex-col py-11">
          ...
          <div className="grid grid-cols-3 gap-4 mb-10">
            {
              infografis && infografis?.map((value, index) => (
                <Button className="flex flex-col infografis-card text-small gap-0" key={index}>
                  <Image
                    alt="produk"
                    className="object-cover w-full"
                  ...
                  <div className="infografis-card-body">
                    <p className="font-bold">Layanan Aduan Konten</p>
                  </div>
                </Button>
              ))
            }
        ...
        <section className="footer-section flex flex-col">
          <div className="grid grid-cols-2 gap-4">
            <div className="py-6">
              ...
              <p className="text-small font-light">Gedung Utama Lantai 5  Kementerian Komunikasi dan Informatika  <br/>JIn. Medan Merdeka Barat No. 9, 10110  Jakarta Pusat, Indonesia</p>
            ...
            <div className="flex">
              <div className="flex items-end" style={{ marginLeft: "-50px" }}>
                <Image alt="phone" src="assets/phone.png" radius="none" removeWrapper/>
              </div>
