...
const SectionBerita: React.FC<SectionBeritaProps> = (props) => {
  ...
  return (
    <section className="secondary-section flex flex-col py-11">
      ...
      <div className="font-bold my-6 text-4xl text-title">Berita Terkini</div>
          ...
          {dataTop5?.map((value, index) => (
            ...
            >
              ...
              <div className="berita-card-body">
                ...
                <span className="font-light mt-2" style={{ color: "#827272" }}>
                  {value.excerpt.length > 200
                    ? value.excerpt
                        .substr(0, value.excerpt.slice(0, 200).lastIndexOf(" "))
                        .concat("…")
                    : value.excerpt}
                </span>
              </div>
