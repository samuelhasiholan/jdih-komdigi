    ...
    <section className="carousel-section flex flex-col py-11">
      ...
      >
        ...
        >
          ...
          />
          <span>POS</span>
          <span className="text-description" style={{ letterSpacing: "0.3px" }}>
            6 peraturan
          </span>
        </Button>
        <Button
        ...
        <Button
          className="flex flex-col tema-card items-center whitespace-normal w-full"
          onClick={() => props.openModal("tema", "Telusur Tema", "Penyiaran")}
        >
          <Image
            className="mb-4"
            height={78}
        ...
        <Button
          className="flex flex-col tema-card items-center whitespace-normal w-full"
          onClick={() =>
            props.openModal("tema", "Telusur Tema", "Frekuensi Radio")
          }
        >
          <Image
            className="mb-4"
        ...
        <Button
          className="flex flex-col tema-card items-center whitespace-normal w-full"
          onClick={() => props.openModal("tema", "Telusur Tema", "Sertifikasi")}
        >
          <Image
            className="mb-4"
            height={78}
