    ...
    return (
        <section className="secondary-section flex flex-col py-11">
            ...
            <div className="flex flex-wrap gap-4 items-center mb-6">
                <Button color={top5View ? "primary" : "default"} onClick={() => setTop5View(true)}>Terbaru</Button>
                <Button color={top5View ? "default" : "primary"} onClick={() => setTop5View(false)}>Terpopuler</Button>
            </div>
                        ...
                        {dataTop5Produk?.map((value, index) => (
                            ...
                            >
                                ...
                                <Image
                                    ...
                                    src={
                                        value.thumbnail 
                                        ? process.env.NEXT_PUBLIC_ACCOUNT_BASE_URL + '/' + value.thumbnail
                                        : emptyImg.src
                                    }
                                    radius="none"
                                    removeWrapper
