    ...
    >
      <ModalContent>
        ...
        <ModalBody>
          ...
          {action === "produk" && (
            <ProdukHukum search={detail} onOpen={(value) => setDetail(value)} />
          )}
          {action === "tv" && (
            <TV search={detail} onOpen={(value) => setDetail(value)} />
          )}
          {action === "infografis" && (
            <Infografis search={detail} onOpen={(value) => setDetail(value)} />
          )}
